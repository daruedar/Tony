...
public class densidadElectronica extends JPanel implements ActionListener{
	...
	public densidadElectronica(){inicializar();}//Fin del constructor

	@Override
	public void actionPerformed(ActionEvent e) {if(e.getSource()==b1){salida.setText(""+getDensidadDeElectrones());}}
	public double getDensidadAtomicaSilicio(){
		...
		//double cas=0;
		return sal;
	}//Fin del metodo getDensidadAtomicaSilicio
	public void inicializar(){
		...
		uni= new JLabel("electrones/metro cubico");
		label3= new JTextArea(5,6);
...
}//Fin de la clase principal densidadElectronica
